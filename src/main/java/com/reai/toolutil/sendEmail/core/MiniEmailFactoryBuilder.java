package com.reai.toolutil.sendEmail.core;

import com.reai.toolutil.sendEmail.config.MailConfig;
import com.reai.toolutil.sendEmail.constant.SmtpHostEnum;
import com.reai.toolutil.sendEmail.exception.ParameterException;
import com.reai.toolutil.sendEmail.util.StringUtils;
/**
